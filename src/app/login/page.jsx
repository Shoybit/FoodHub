...
export default function LoginPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      toast.error(`${error.message || "Invalid Credentials"}`, { autoClose: 3000 });
  ...
  async function handleGoogleLogin() {
    ...
    try {
      ...
      toast.success("Google Login successful!", { autoClose: 2500 });
      setTimeout(() => {
        router.push("/"); 
      }, 1500);
    } catch (error) {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 bg-gray-800 border rounded-lg focus:outline-none focus:ring-2 transition-all duration-200 ${
                errors.email ? "border-red-500 focus:ring-red-500" : "border-gray-700 focus:ring-orange-500 focus:border-orange-500"
          ...
          <div>
            ...
            <input
              ...
              required
              className={`w-full px-4 py-3 bg-gray-800 border rounded-lg focus:outline-none focus:ring-2 transition-all duration-200 ${
                errors.password ? "border-red-500 focus:ring-red-500" : "border-gray-700 focus:ring-orange-500 focus:border-orange-500"
              } text-white placeholder-gray-400`}
